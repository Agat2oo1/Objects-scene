...
namespace ObjParser
{
	public class Obj
	{
		...
		public List<NormalVector> NVectorList;
	    ...
	    public Obj()
	    {
			...
			NVectorList = new List<NormalVector>();
        }
		...
		public void RescaleVertices()
		{
			for(int i=0;i<VertexList.Count;i++)
			{
				VertexList[i].X /= Size.XMax;
                VertexList[i].Y /= Size.YMax;
            }	
		}
		...
		public void WriteObjFile(string path, string[] headerStrings)
		{
			...
			using (var writer = new StreamWriter(outStream))
			{
				...
				NVectorList.ForEach(tv => writer.WriteLine(tv));
				string lastUseMtl = "";
