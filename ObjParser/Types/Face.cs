...
namespace ObjParser.Types
{
    public class Face : IType
    {
        ...
        public int[] NormalVectorIndexList { get; set; }
        ...
        public void LoadFromStringArray(string[] data)
        {
            ...
            NormalVectorIndexList = new int[vcount];

			bool success;

            for (int i = 0; i < vcount; i++)
            {
                string[] parts = data[i + 1].Split(new string[] { "//" }, StringSplitOptions.None);
                ...
                if (parts.Count() > 1)
                {
                    ...
                    if (success) {
                        NormalVectorIndexList[i] = vindex;
                    }
                }
            }
        }
        ...
        public override string ToString()
        {
            ...
            {                 
                b.AppendFormat(" {0}//{1}", VertexIndexList[i], NormalVectorIndexList[i]);
            }
